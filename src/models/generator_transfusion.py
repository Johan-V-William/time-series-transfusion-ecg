"""
Paper:
TransFusion: Generating Long, High Fidelity Time Series using Diffusion Models with Transformers (2025)
Reference: https://arxiv.org/abs/2502.08671
Authors: Fahim Sikder, Resmi Ramachandranpillai, Fredrik Heintz
License: Apache-2.0

This code is adapted from:
Repository: https://github.com/fahim-sikder/TransFusion
Code author: Fahim Sikder 
Original file: ddpm.py

Modifications:
- Not change now, but we will modify the code to fit our needs in the future.
